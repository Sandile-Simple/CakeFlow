    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DesignInstructionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    ReferenceImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DesignNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ColourScheme = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DecoratorNotes = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DesignInstructions", x => x.DesignInstructionId);
                    table.ForeignKey(
                        name: "FK_DesignInstructions_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DesignInstructions_OrderId",
                table: "DesignInstructions",
                column: "OrderId",
                unique: true);
